...
function SectionHeader({ title, action = "Ver todos" }: { title: string; action?: string }) {
  return (
    <div className="mb-3 flex items-center justify-between px-5 md:px-0">
      <h2 className="text-[22px] font-black tracking-tight text-ink md:text-2xl">{title}</h2>
...
function GameCard({ game, compact = false, onPlay }: { game: Game; compact?: boolean; onPlay: (game: Game) => void }) {
  ...
  return (
    <article
      ...
      } ${compact ? "h-[246px] w-[154px] min-[390px]:w-[166px] md:h-[258px] md:w-full" : "h-[286px] w-[182px] min-[390px]:w-[190px] md:h-[306px] md:w-full"}`}
    >
      <button className="flex h-full w-full flex-col text-left" onClick={() => onPlay(game)}>
        <div className={`${compact ? "h-[112px] md:h-[126px]" : "h-[124px] md:h-[142px]"} relative overflow-hidden bg-zinc-100`}>
...
function HorizontalGames({
  ...
  return (
    <section className="py-3 md:py-5">
      ...
      <div className="hide-scrollbar flex gap-3 overflow-x-auto px-5 pb-2 md:grid md:grid-cols-4 md:gap-4 md:overflow-visible md:px-0 xl:grid-cols-5">
        {games.map((game) => (
...
function DailyChallenge({ daily, onPlay }: { daily: Game; onPlay: (game: Game) => void }) {
  return (
    <section className="mx-4 mt-5 overflow-hidden rounded-lg border border-teal-500/35 bg-white shadow-ranked min-[390px]:mx-5 md:mx-0 md:mt-6">
      <div className="grid min-h-[226px] grid-cols-[1.04fr_.96fr] max-[374px]:grid-cols-1 md:min-h-[330px] md:grid-cols-[1.05fr_.95fr]">
        <div className="flex flex-col justify-between p-4 min-[390px]:p-5 md:p-8">
          <div>
            ...
            <h1 className="text-[23px] font-black leading-tight tracking-tight text-ink min-[390px]:text-[25px] md:max-w-md md:text-5xl">{daily.title}</h1>
            <p className="mt-2 text-[13px] leading-6 text-zinc-600 min-[390px]:text-sm md:mt-4 md:max-w-lg md:text-base md:leading-7">{daily.short_description}</p>
          </div>
          <div className="mt-4 space-y-3">
            ...
            <button
              ...
              className="flex h-12 w-full items-center justify-center gap-2 rounded-lg bg-action text-sm font-black text-white shadow-soft transition active:scale-[.98] md:w-56"
            >
...
function CategoryTabs({
  ...
  return (
    <div className="mx-4 mt-5 grid h-12 grid-cols-4 overflow-hidden rounded-lg border border-line bg-white text-sm font-black shadow-soft min-[390px]:mx-5 md:mx-0 md:max-w-xl">
...
function HomeView({
  ...
  return (
    <>
      <header className="px-5 pt-7 md:px-0 md:pt-8">
        <div className="flex items-start justify-between gap-3">
          <div>
            <p className="text-[23px] font-black leading-tight tracking-tight text-ink min-[390px]:text-[26px] md:text-4xl">
              Só Mais Uma Fase
            </p>
            <p className="mt-1 text-[13px] font-medium text-muted min-[390px]:text-sm md:text-base">
      ...
      <section className="px-5 py-4 md:hidden">
        <button
      ...
      <section className="hidden py-5 md:grid md:grid-cols-[1fr_360px] md:gap-5">
        <button
          onClick={() => setTab("ranking")}
      ...
      <section className="py-4 md:py-5">
        ...
        <div className="hide-scrollbar flex gap-3 overflow-x-auto px-5 pb-2 md:grid md:grid-cols-3 md:overflow-visible md:px-0">
          {hallOfFame.map((item) => (
            <button
              key={item.title}
              onClick={() => setTab("hall")}
              className="w-[230px] shrink-0 rounded-lg border border-amber-300/60 bg-white p-4 text-left shadow-soft md:w-full"
            >
...
function RankingView() {
  ...
  return (
    <main className="px-5 pb-32 pt-7 md:mx-auto md:max-w-5xl md:px-0 md:pb-12 md:pt-8">
      <div className="mb-5">
...
function QuickView({ games, onPlay }: { games: Game[]; onPlay: (game: Game) => void }) {
  ...
  return (
    <main className="px-5 pb-32 pt-7 md:mx-auto md:max-w-6xl md:px-0 md:pb-12 md:pt-8">
      ...
      <div className="mt-5 grid grid-cols-2 gap-3 md:grid-cols-4 md:gap-4 xl:grid-cols-5">
...
function ProfileView() {
  return (
    <main className="px-5 pb-32 pt-7 md:mx-auto md:max-w-2xl md:px-0 md:pb-12 md:pt-8">
...
function DesktopNav({ tab, setTab }: { tab: Tab; setTab: (tab: Tab) => void }) {
  return (
    <nav className="sticky top-0 z-40 hidden border-b border-line bg-paper/95 py-4 backdrop-blur md:block">
      <div className="flex items-center justify-between">
        <div>
...
export function GamePortal({ games }: { games: Game[] }) {
  ...
  if (selectedGame) {
    return (
      <div className="mx-auto min-h-screen w-full max-w-[430px] bg-paper shadow-[0_0_0_1px_rgba(228,228,231,.7)] max-[500px]:mx-0 md:max-w-5xl md:shadow-none">
  ...
  return (
    <div className="mx-auto min-h-screen w-full max-w-[430px] bg-paper pb-36 shadow-[0_0_0_1px_rgba(228,228,231,.7)] max-[500px]:mx-0 md:max-w-6xl md:px-6 md:pb-12 md:shadow-none">
      ...
      <nav className="fixed bottom-0 left-1/2 z-50 grid h-[76px] w-full max-w-[430px] -translate-x-1/2 grid-cols-5 border-t border-line bg-white/96 px-2 pb-2 pt-1 shadow-[0_-12px_30px_rgba(24,24,27,.08)] backdrop-blur max-[500px]:left-0 max-[500px]:translate-x-0 md:hidden">
        {navItems.map((item) => {
          const Icon = item.icon;
          const active = tab === item.id;
          return (
